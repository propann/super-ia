...
async function load(projectId){
  ...
  try{
    ...
    el('cards').innerHTML=[
      ['Projets',data.status.projects],['Missions',data.status.tasks],['Runs',data.status.runs],['Runs actifs',data.status.activeRuns],['Événements',data.status.events],['Readiness',data.readiness?.overall || 'indisponible']
