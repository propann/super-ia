...
L'arène persistante des IA et consoles est documentée dans [docs/ARENA.md](docs/ARENA.md). Les groupes sont enregistrés sur le disque dans `SUPERIA_HOME/arena.json`, jamais dans la page web.
...
- [Arène persistante](docs/ARENA.md)
- [Stockage PC → Pi](docs/STORAGE.md)
